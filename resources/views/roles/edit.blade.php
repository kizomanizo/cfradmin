                    ...
                    <div class="col-lg-6 col-offset-2">
                        <form role="form" method="POST" action="{{ url('/roles/'.$role->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="name" id="name" placeholder="Role Name" value="{{ $role->name }}">
                            </div>
                            <div class="form-group">
                                <label for="description">Description</label>
                                <input class="form-control" type="text" name="description" id="description" placeholder="Description" value="{{ $role->description }}">
                            </div>
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <fieldset disabled>
                                        <label>
                                            <input type="radio" name="level" id="system" value="{{ $role->level }}" checked="">Current Level ({{ $role->level }})
                                        </label>
                                        </fieldset>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="level" id="system" value="1">System User(1)
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
